...
#SBATCH -o /n/home08/jromerofontalvo/libor/H2O/test1/outputs/H2O-1.8-libor-LBFGS-trotter-2-read-CAS-0-4.out      # File to which STDOUT will be written
#SBATCH -e /n/home08/jromerofontalvo/libor/H2O/test1/outputs/H2O-1.8-libor-LBFGS-trotter-2-read-CAS-0-4.err      # File to which STDERR will be written
