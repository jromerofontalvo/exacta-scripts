...
python variationalCASlibor.py H2O 1.8-libor 1 "ucc" 0 4 $integralFolder/H2O-1.8-libor.int $guessFolder/H2O-1.8-libor-ucc.guess LBFGS trotter 2 read 0 00110011 $initialState